            ...
            <form action="{{ route('users.update', $user->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <div class="text-center my-3">
                        <img src="{{ asset($user->photo) }}" alt="no-photo" class="img-thumbmail" id="preview" width="150px">
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="">
                        <input id="birthday" type="date" class="form-control @error('birthday') is-invalid @enderror" name="birthday" value="{{ $user->birthday }}" min="{{ date('Y-m-d', strtotime('-100 years')) }}" max="{{ date('Y-m-d', strtotime('-1 day')) }}" required autocomplete="birthday">
                ...
                <div class="d-grid gap-2 mb-3">
                    <button type="submit" class="btn btn-primary btn-block" style="background-color: #117864; border-color:#0c5e4e">Actualizar <i class="fa fa-save mx-2"></i></button>
                </div>
