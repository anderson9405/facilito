@extends('layouts.app')
@section('title', 'Facilito - Crear productos')

@section('content')
<div class="row">
    <div class="col-md-10 offset-md-1">
        <h1 style="color: #0B5345"> <i class="fa fa-plus"></i>Agregar producto</h1>
        <hr>
        ...
        <form method="POST" action="{{route('products.store')}}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="text-center my-3">
                    <img src="{{ asset('images/no-image.png') }}" alt="no-photo" class="img-thumbmail" id="preview" width="150px">
                </div>
            ...
            <div class="d-grid gap-2 mb-3">
                <button type="submit" class="btn btn-primary btn-block" style="background-color: #117864; border-color:#0c5e4e"><i class="fa fa-save mx-2"></i>Agregar producto</button>
            </div>
