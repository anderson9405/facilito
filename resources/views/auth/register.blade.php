@extends('layouts.app')
@section('title', 'Facilito - Registro')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <img src="{{ asset('images/elements/register.svg') }}" alt="img" width="120px" class="my-4 img-top-card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="role_id" class="col-md-4 col-form-label text-md-end">{{ __('Tipo de usuario') }}</label>

                            <div class="col-md-6">
                                <select id="role_id" class="form-select @error('role_id') is-invalid @enderror" name="role_id" required autocomplete="role_id">
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Confirmar contrseña') }}</label>
                        ...
                        <div class="row mb-0">
                            ...
                            <button type="submit" class="btn btn-facilito btn-primary text-uppercase"  style="background-color: #117864; border-color:#0c5e4e">
                                Registro
